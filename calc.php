...
<html>
  ...
  <body>
   ...
   <?php include('Prefabs/header.php');?>
    ...
    {
      echo("<div><br>$purchaseData[0]:<br></div>");
      echo("<div>---Purchase cost: $$purchaseData[1]<br></div>");
      echo("<div>---Install cost: $$purchaseData[2]<br></div>");
      echo("<div>---Tax rebate: $$purchaseData[4]<br></div>");
      $overallCost = $purchaseData[3]-$purchaseData[4];
      echo("<div>---Overall cost: $$overallCost <br></div>");
      echo("<div>---Energy saved per month: $purchaseData[5] kW<br></div>");
      echo("<div>---Years till even: $purchaseData[6] <br></div>");
